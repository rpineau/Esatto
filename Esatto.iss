...
#define MyAppName "Esatto and Arco X2 Driver"
#define MyAppVersion "1.70"
...
; Rotator!
Source: "rotatorlist Arco.txt";                   DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion
Source: "rotatorlist Arco.txt";                   DestDir: "{app}\Miscellaneous Files"; DestName: "rotatorlist64 Arco.txt";Flags: ignoreversion
;32 bits
Source: "libArco\Win32\Release\libArco.dll";    DestDir: "{app}\Plugins\RotatorPlugIns/"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\RotatorPlugIns/'))
Source: "Arco.ui";                                DestDir: "{app}\Plugins\RotatorPlugIns/"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\RotatorPlugIns/'))
Source: "PrimaLuceLab.png";                         DestDir: "{app}\Plugins\RotatorPlugIns/"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\RotatorPlugIns/'))
; 64 bits
Source: "libArco\x64\Release\libArco.dll";      DestDir: "{app}\Plugins64\RotatorPlugIns/"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\RotatorPlugIns/'))
Source: "Arco.ui";                                DestDir: "{app}\Plugins64\RotatorPlugIns/"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\RotatorPlugIns/'))
Source: "PrimaLuceLab.png";                         DestDir: "{app}\Plugins64\RotatorPlugIns/"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\RotatorPlugIns/'))
